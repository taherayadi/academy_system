  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="bg-white border border-slate-200/70 p-6 rounded-3xl shadow-lg shadow-slate-900/5">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              type="button"
              onClick={() => shiftDate(-1)}
              className="px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-black text-slate-600 hover:border-brand-600/40 hover:text-brand-600 transition cursor-pointer"
            >
              اليوم السابق
            </button>
            <label className="relative flex items-center gap-2 px-3 py-2 bg-white border-2 border-brand-600/20 rounded-xl">
        ...
        <div className="mt-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-2xl bg-brand-600/[0.05] border border-brand-600/15 px-4 py-3">
          <div>
            <p className="text-sm font-black text-brand-700">{dateLabel(selectedDate)}</p>
      ...
      <div className="bg-white border border-slate-200/70 rounded-3xl p-5 shadow-lg shadow-slate-900/5 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-brand-600 text-white rounded-xl text-xs font-black shadow-md shadow-brand-600/25 hover:shadow-lg transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
