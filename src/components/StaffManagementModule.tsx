...
const base = generatingPayslipStaff.baseSalary || 850;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* SUB TABS NAVIGATION */}
      <div className="bg-white p-2 rounded-2xl border border-slate-200/70 flex gap-2 no-print">
        <button
        ...
        {cinErrorDialog.open && (
          <div className="fixed inset-0 z-[60] bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-4 no-print">
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden my-8 border border-slate-200/70"
            >
